// ═══════════════════════════════════════════════════════════════════════════════
// src/worker.js — النسخة النهائية (تعتمد على keyEvents)
// ═══════════════════════════════════════════════════════════════════════════════
...
function extractEvents(data) {
  ...
  // المصدر الرئيسي: keyEvents (يحتوي على كل شيء مع الوقت)
  ...
  for (const ev of events) {
    ...
    if (evType === 'substitution' || evType === 'substitution-out' || evType === 'substitution-in') {
      let playerIn = player1;
      let playerOut = player2;
      let jerseyIn = jersey1;
      let jerseyOut = jersey2;
      
      // إذا كان النوع substitution-in، اللاعب الأول هو الداخل
  ...
  // ── مصدر إضافي: details (للأهداف التي قد تكون مفقودة) ──
