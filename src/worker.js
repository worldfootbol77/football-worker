// ═══════════════════════════════════════════════════════════════════════════════
// src/worker.js — النسخة النهائية المُصلَحة (مع قواعد ألوان التأهل والهبوط)
// ═══════════════════════════════════════════════════════════════════════════════
...
const CONTINENTAL_RULES = {
    ...
    "uefa.champions": {
        1: {color: "#81D6AC", desc: "تأهل لدور الـ 16"},
        2: {color: "#81D6AC", desc: "تأهل لدور الـ 16"},
        3: {color: "#B2BFD0", desc: "الملحق المؤهل لدور الـ 16"},
        4: {color: "#B2BFD0", desc: "الملحق المؤهل لدور الـ 16"}
    },
    "eng.1": { // الدوري الإنجليزي الممتاز
        1: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        2: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        3: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        4: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        5: {color: "#95D5B2", desc: "الدوري الأوروبي"},
        18: {color: "#E63946", desc: "الهبوط لدوري البطولة (Championship)"},
        19: {color: "#E63946", desc: "الهبوط لدوري البطولة (Championship)"},
        20: {color: "#E63946", desc: "الهبوط لدوري البطولة (Championship)"}
    },
    "esp.1": { // الدوري الإسباني
        ...
        4: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        5: {color: "#95D5B2", desc: "الدوري الأوروبي"},
        6: {color: "#A2D2FF", desc: "دوري المؤتمر الأوروبي"},
        18: {color: "#E63946", desc: "الهبوط للدرجة الثانية"},
        19: {color: "#E63946", desc: "الهبوط للدرجة الثانية"},
        20: {color: "#E63946", desc: "الهبوط للدرجة الثانية"}
    },
    "ger.1": { // الدوري الألماني
        ...
        4: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        5: {color: "#95D5B2", desc: "الدوري الأوروبي"},
        16: {color: "#F59E0B", desc: "ملحق البقاء / الهبوط"},
        17: {color: "#E63946", desc: "الهبوط المباشر للدرجة الثانية"},
        18: {color: "#E63946", desc: "الهبوط المباشر للدرجة الثانية"}
    },
    ...
    "fra.1": { // الدوري الفرنسي
        ...
        2: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        3: {color: "#58A6FF", desc: "دوري أبطال أوروبا"},
        4: {color: "#95D5B2", desc: "تصفيات دوري أبطال أوروبا"},
        5: {color: "#A2D2FF", desc: "الدوري الأوروبي"},
        16: {color: "#F59E0B", desc: "ملحق البقاء"},
        17: {color: "#E63946", desc: "الهبوط للدرجة الثانية"},
        18: {color: "#E63946", desc: "الهبوط للدرجة الثانية"}
    }
};
...
async function handleStandings(url, env) {
  ...
  try {
    ...
    // جلب القواعد المحددة لهذا الدوري إن وجدت
    const leagueRules = CONTINENTAL_RULES[league] || null;
    ...
    for (const child of children) {
      ...
      const teams = entries.map(e => {
        ...
        const currentRank = parseInt(stats.rank) || (entries.indexOf(e) + 1);

        // إضافة معلومات التأهل والهبوط بناءً على المركز الحالي
        let rule = { color: "", desc: "" };
        if (leagueRules && leagueRules[currentRank]) {
            rule = leagueRules[currentRank];
        }
