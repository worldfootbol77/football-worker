...
// ─── Parse ESPN Event (مع التصحيح النهائي) ───────────────────────────────────
function parseEvent(ev) {
  ...
  // ✅ التصحيح النهائي - اقرأ من league.displayName أولاً
  const leagueName = ev.league?.displayName     // هذا هو الحقل الصحيح ✅
                  || ev.leagues?.[0]?.displayName 
