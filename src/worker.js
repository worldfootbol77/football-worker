// ═══════════════════════════════════════════════════════════════════════════════
// src/worker.js — النسخة الشاملة والنهائية المتكاملة
// ═══════════════════════════════════════════════════════════════════════════════
...
// ─── قواعد الألوان للتأهل والهبوط (Continental Rules) ─────────────────────────
...
// قاموس تحويل المعرفات الرقمية لـ ESPN إلى أكواد نصية
const ID_TO_CODE = {
...
function applyFallbackColors(leagueCode, position, totalTeams) {
    ...
    if (rules) {
        if (rules[position]) {
            ...
            const offset = position - totalTeams - 1; // التعامل مع المؤشرات السالبة للهبوط (-1, -2, -3)
            if (rules[offset]) {
                return rules[offset];
            }
        }
