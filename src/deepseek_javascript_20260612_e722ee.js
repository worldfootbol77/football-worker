...
const LEAGUE_ID_MAP = {
  ...
  '606':   { slug: 'fifa.world',              name: '🌍 كأس العالم' },
  '786':   { slug: 'fifa.worldq.uefa',        name: '🌍 تصفيات كأس العالم - أوروبا' },
  '787':   { slug: 'fifa.worldq.conmebol',    name: '🌍 تصفيات كأس العالم - أمريكا الجنوبية' },
  '788':   { slug: 'fifa.worldq.concacaf',    name: '🌍 تصفيات كأس العالم - أمريكا الشمالية' },
  '789':   { slug: 'fifa.worldq.afc',         name: '🌍 تصفيات كأس العالم - آسيا' },
  '790':   { slug: 'fifa.worldq.caf',         name: '🌍 تصفيات كأس العالم - أفريقيا' },
  '781':   { slug: 'uefa.euro',               name: '🏆 بطولة أمم أوروبا' },
  '3908':  { slug: 'caf.nations',             name: '🏆 كأس أمم أفريقيا' },
  '4004':  { slug: 'concacaf.gold',           name: '🏆 كأس الكونكاكاف الذهبية' },
  
  // البطولات الأوروبية القارية
  '775':   { slug: 'uefa.champions',          name: '🏆 دوري أبطال أوروبا' },
  '776':   { slug: 'uefa.europa',             name: '🏆 الدوري الأوروبي' },
  
  // الدوريات الأوروبية الكبرى
  '700':   { slug: 'eng.1',                   name: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 الدوري الإنجليزي الممتاز' },
  '740':   { slug: 'esp.1',                   name: '🇪🇸 الدوري الإسباني' },
  '720':   { slug: 'ger.1',                   name: '🇩🇪 الدوري الألماني' },
  '730':   { slug: 'ita.1',                   name: '🇮🇹 الدوري الإيطالي' },
  '710':   { slug: 'fra.1',                   name: '🇫🇷 الدوري الفرنسي' },
  '715':   { slug: 'por.1',                   name: '🇵🇹 الدوري البرتغالي' },
  '725':   { slug: 'ned.1',                   name: '🇳🇱 الدوري الهولندي' },
  '3946':  { slug: 'tur.1',                   name: '🇹🇷 الدوري التركي' },
  
  // دوريات أوروبية أخرى
  '735':   { slug: 'sco.1',                   name: '🏴󠁧󠁢󠁳󠁣󠁴󠁿 الدوري الاسكتلندي' },
  '3901':  { slug: 'bel.1',                   name: '🇧🇪 الدوري البلجيكي' },
  '3955':  { slug: 'gre.1',                   name: '🇬🇷 الدوري اليوناني' },
  '3939':  { slug: 'rus.1',                   name: '🇷🇺 الدوري الروسي' },
  '3907':  { slug: 'aut.1',                   name: '🇦🇹 الدوري النمساوي' },
  '3913':  { slug: 'den.1',                   name: '🇩🇰 الدوري الدنماركي' },
  '3960':  { slug: 'nor.1',                   name: '🇳🇴 الدوري النرويجي' },
  '3945':  { slug: 'swe.1',                   name: '🇸🇪 الدوري السويدي' },
  
  // بطولات قارية
  '783':   { slug: 'conmebol.libertadores',   name: '🏆 كوبا ليبرتادوريس' },
  '5454':  { slug: 'conmebol.sudamericana',   name: '🏆 كوبا سوداميريكانا' },
  '3902':  { slug: 'afc.champions',           name: '🏆 دوري أبطال آسيا' },
  '2391':  { slug: 'caf.champions',           name: '🏆 دوري أبطال أفريقيا' },
  
  // دوريات الأمريكتين
  '745':   { slug: 'arg.1',                   name: '🇦🇷 الدوري الأرجنتيني' },
  '630':   { slug: 'bra.1',                   name: '🇧🇷 الدوري البرازيلي' },
  '760':   { slug: 'mex.1',                   name: '🇲🇽 الدوري المكسيكي' },
  '770':   { slug: 'usa.1',                   name: '🇺🇸 MLS' },
  '650':   { slug: 'col.1',                   name: '🇨🇴 الدوري الكولومبي' },
  '660':   { slug: 'ecu.1',                   name: '🇪🇨 الدوري الإكوادوري' },
  '670':   { slug: 'per.1',                   name: '🇵🇪 الدوري البيروفي' },
  
  // دوريات آسيا والخليج
  '21231': { slug: 'ksa.1',                   name: '🇸🇦 الدوري السعودي' },
  '750':   { slug: 'jpn.1',                   name: '🇯🇵 الدوري الياباني' },
  '8376':  { slug: 'chn.1',                   name: '🇨🇳 الدوري الصيني' },
  '3906':  { slug: 'aus.1',                   name: '🇦🇺 الدوري الأسترالي' },
  '8316':  { slug: 'ind.1',                   name: '🇮🇳 الدوري الهندي' },
};
...
// ─── Parse ESPN Event (باستخدام league_id من uid) ────────────────────────────
function parseEvent(ev) {
  ...
  const uid = ev.uid || '';
  const leagueIdMatch = uid.match(/l:(\d+)/);
  const leagueId = leagueIdMatch ? leagueIdMatch[1] : null;
  
  // الحصول على اسم الدوري من القاموس
  const leagueInfo = LEAGUE_ID_MAP[leagueId];
  let leagueName = leagueInfo?.name || '';
  let leagueCode = leagueInfo?.slug || '';
  
  // إذا لم نجد الدوري في القاموس، نستخدم الطريقة القديمة
  if (!leagueName) {
    const seasonSlug = ev.season?.slug || ev.league?.slug || '';
    leagueCode = slugToLeagueCode(seasonSlug) || seasonSlug;
    leagueName = ev.season?.displayName || ev.league?.displayName || ev.name?.split(':')[0]?.trim() || '';
  }
  
  const note = comp.notes?.[0]?.headline || '';
  const round = note || (ev.season?.slug === 'group-stage' ? 'دور المجموعات' : '');
